...
def init_args():
    ...
    # parser.add_argument("--rec_model_dir", type=str, default='../../base/best.onnx')
    parser.add_argument("--rec_model_dir", type=str, default=r'/app/base/best.onnx')
